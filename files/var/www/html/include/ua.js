...
var config = {
  uri: "websip@kamailio.websip.dev",
  password: "websip",
  wsServers: "wss://kamailio.websip.dev:443",
  register: true,
  traceSip: true,
  iceCheckingTimeout: 500,
  stunServers: "stun:turn.websip.dev:81",
  turnServers: {
    urls:"turn:turn.websip.dev:80?transport=tcp",
    username:"websip",
    password:"websip"
  }
};
